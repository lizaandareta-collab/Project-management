                                        ...
                                        <div class="data">
                                            ...
                                            <div class="info">
                                                <span class="change down text-danger">
                                                    <em class="icon ni ni-arrow-long-down"></em>2.34%
                                                </span>
                                                <span> vs. last week</span>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                <div class="nk-ecwg nk-ecwg6">
                                    <div class="card-inner">
                                        <div class="card-title-group">
                                            <div class="card-title">
                                                <h6 class="title">Laboratory Income</h6>
                                            </div>
                                        </div>
                                        <div class="data">
                                            <div class="data-group">
                                        ...
                                        <div class="data">
                                            ...
                                            <div class="info">
                                                <span class="change up text-primary">
                                                    <em class="icon ni ni-arrow-long-up"></em>1.34%
                                                </span>
                                                <span> vs. last week</span>
                                            </div>
                                        </div>
                                ...
                                <div class="card-inner">
                                    ...
                                    <ul class="nk-store-statistics">
                                        ...
                                        <li class="item">
                                            ...
                                            <em class="icon bg-pink-dim ni ni-plus-fill-c"></em>
                                        </li>
                                        <li class="item">
                                            <div class="info">
                                        ...
                                        <ul class="timeline-list">
                                            <li class="timeline-item">
                                                ...
                                                <div class="timeline-data">
                                                    <h6 class="timeline-title">Test Reports In Laboratory Sample</h6>
                                                    <div class="timeline-des">
                                                        <p>Re-check test results asap.</p>
...
@push('scripts')
<script src="{{ asset('assets/js/charts/gd-hospital.js') }}?ver=3.2.0"></script>
@endpush